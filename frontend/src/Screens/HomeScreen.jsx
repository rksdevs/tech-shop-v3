  ...
  return (
    <div className="flex w-full flex-col gap-8 overflow-hidden">
      <div className="banner relative flex flex-col lg:flex-row bg-muted max-w-full max-h-[40vh] mt-4 py-4 rounded-md overflow-hidden">
        <div className="relative content flex flex-col gap-4 flex-1 p-4 lg:p-[5rem] items-start text-left z-10 pt-10 md:pt-4">
          <h2
            className={`tracking-[0.025rem] font-[700] text-[1.5rem] lg:text-[2.5rem] leading-[1.75rem] lg:leading-[2.5rem] text-[#ea580c] lg:text-black ${
          ...
          >
            ...
            <span className="italic font-bold tracking-[0.075rem] text-[16px] text-primary">
              Merlin
            </span>
          </p>
          <Link to="/allproducts">
        ...
        <div className="image lg:relative absolute inset-0 lg:inset-auto flex-1 lg:flex-none lg:w-[390px]">
          <div className="w-full h-full absolute inset-0 bg-black opacity-25 lg:opacity-0"></div>
          <img
            src={bannerOne}
            alt="banner"
            className="w-full h-full object-cover lg:object-contain relative lg:absolute left-[30px]"
          />
        </div>
      </div>
      ...
      <div className="banner flex flex-col max-w-full rounded-md gap-4">
        <div className="relative flex flex-col lg:flex-row h-full w-full bg-muted rounded-md">
          <div className="flex-1 flex items-center justify-center">
            <div className="flex flex-col gap-4 max-w-md text-left p-4">
        ...
        <div className="flex flex-col lg:flex-row gap-2 lg:max-h-[25vh]">
          <div className="custom-pc-one flex bg-muted rounded-md lg:w-1/2 max-h-[25vh]">
            <div className="content flex flex-col gap-4 w-1/2 p-[1rem] lg:p-[3rem] pt-[3.5rem] lg:pt-[3rem] items-start text-left">
              <h2 className="font-[600] text-[1rem] leading-[1rem] lg:tracking-[0.015rem] lg:font-[700] lg:text-[1.5rem] lg:leading-[1.5rem]">
              ...
              <Link to="/prebuilt-pc" className="min-w-[75px]">
          ...
          <div className="custom-pc-two flex bg-muted rounded-md lg:w-1/2 max-h-[25vh]">
            <div className="content flex flex-col gap-4 w-1/2 p-[1rem] lg:p-[3rem] pt-[3.5rem] lg:pt-[3rem] items-start text-left">
              ...
              <Link to="/buildcustompc" className="min-w-[7rem]">
      ...
      <div className="banner flex bg-muted max-w-full max-h-[30vh] rounded-md">
        ...
        <div className="content flex flex-col gap-4 flex-1 p2 p-[3.5rem] items-start text-left">
