...
const ProcessorTable = ({
  ...
  const handleAddItem = (e, product, qty = 1) => {
    e.stopPropagation();
  ...
  const columns = [
    ...
    columnHelper.accessor((row) => row, {
      ...
      cell: (info) => (
        ...
        // <DropdownMenu
        //   open={tableActionDropdownOpen}
        //   onOpenChange={setTableActionDropdownOpen}
        // >
  ...
  return (
    <Container className="flex flex-col gap-4">
      <div className="section-heading flex justify-end md:justify-between items-center">
        <h1 className="font-extrabold hidden md:flex">Processors</h1>
