...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route path="/" element={<App />}>
      ...
      <Route
        path="/allproducts/search/:keyword/page/:pageNumber"
        element={<AllProducts />}
      />
      ...
      <Route path="" element={<AdminRoute />}>
        ...
        <Route
          path="/admin/all-products/:pagenumber"
        ...
        <Route
          path="/admin/allproducts/editProduct/:slug"
          element={<EditProduct />}
        />
        <Route
          path="/admin/allorders/editOrder/:id"
          element={<PlaceOrderScreen />}
        />
        <Route
          path="/admin/configurePrebuiltPc"
          element={<ConfigurePrebuiltPc />}
        />
        <Route path="/admin/editPrebuiltPc/:id" element={<EditPrebuiltPc />} />
        <Route
          path="/admin/edit-admin-details"
          element={<EditAdminDetails />}
        />
        <Route
          path="/admin/orderUpdate/shiprocket/:id"
          element={<ShiprocketScreen />}
        />
      </Route>
